...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        self.cleaned = [[False for i in range(height)] for i in range(width)]
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return sum(map(sum, self.cleaned))
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for i in range(num_trials):
        ...
        stepResults.append(num_steps)
        #anim.done()
    return sum(stepResults) / float(len(stepResults))
